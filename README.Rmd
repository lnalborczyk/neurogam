...
To use `neurogam` functions in Julia (e.g., on MNE epochs), we recommend using the `RCall` package (<https://juliainterop.github.io/RCall.jl/stable/>) (thanks to Benedikt Ehinger for sharing this code snippet).
